...
import static mate.academy.intro.util.TestOrderDataUtil.createEmptyOrderDtoSampleFromEntity;
import static mate.academy.intro.util.TestOrderDataUtil.createEmptyOrderSample;
import static mate.academy.intro.util.TestOrderDataUtil.createOrderItemDtoSampleFromEntity;
import static mate.academy.intro.util.TestOrderDataUtil.createOrderItemSample;
import static mate.academy.intro.util.TestShoppingCartDataUtil.createCartItemSample;
import static mate.academy.intro.util.TestShoppingCartDataUtil.createEmptyShoppingCartSample;
